...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Noto+Serif+Telugu:wght@400;600;700&family=Baloo+Tammudu+2:wght@500;700&family=Cormorant+Garamond:ital,wght@0,500;1,500&display=swap",
      },
